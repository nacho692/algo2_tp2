...
\end{algorithmic}
\underline{Complejidad:} $\Ogr(1)$
\underline{Justificacion:} $\Ogr(1) + n*\Ogr(1)*m\Ogr(1)$ = $\Ogr(n*m)$ donde n es la cantidad de vecinos de una posicion y m es la cantidad de agentes vecinos a una posicion, ambas acotadas por 4.\\
$\Ogr(4*4)$ = $\Ogr(16)$ = $\Ogr(1)$
\end{algorithm}
