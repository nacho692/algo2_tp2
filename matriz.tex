...
\begin{Representacion}
	...
	\Rep{true $\implies$ ancho $>$ $0$ $\land$ alto $>$ $0$ $\land _l$ tamaño(e.matriz) = ancho $\land$ ($\forall$ i : nat) i $\geq$ $0$ $\land$ i $<$ ancho $\land$ i $<$ alto $\implies$ tamaño(e.matriz) = ancho $\land$ tamaño(e.matriz[i]) = alto }
