...
\begin{Representacion}
	...
	\Rep{true $\leftrightarrow$ ancho $>$ $0$ $\land$ alto $>$ $0$ $\land _l$ tamaño(e.matriz) = ancho $\land$ ($\forall$ i : nat) i $\geq$ $0$ $\land$ i $<$ ancho $\land$ i $<$ alto $\rightarrow$ tamaño(e.matriz) = ancho $\land$ tamaño(e.matriz[i]) = alto }
